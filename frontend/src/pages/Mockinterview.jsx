...
const Mockinterview = () => {
  ...
  const handleViewResults = () => currentCallId && setCurrentView('results');
  ...
  if (currentView === 'results') {
    return <MockinterviewResults callId={currentCallId} onBack={handleBackToForm} />;
  }
              ...
              {currentCallId && (
                <div className="flex items-center space-x-6">
                  <div className="bg-gray-50 px-4 py-2 rounded-full">
                    ...
                    <span className="text-sm font-mono text-black">{currentCallId.slice(-8)}</span>
                  </div>
                  <button
...
return (
  ...
  <div className="min-h-screen bg-white relative overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center justify-start px-6 lg:px-20 pt-12 pb-16 gap-10">
      {/* Top Section: Header and Image side by side */}
      <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-between gap-12">
        {/* Left: Header */}
        <div className="max-w-xl borde text-center lg:text-left">
          ...
          <span className="block text-2xl text-gray-600 font-normal mb-4">
            Practice. Perfect. Succeed.
          </span>
